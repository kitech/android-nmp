...
CC="$ACC" BUILD_CC="$ACC" LD=$ALD  CPPFLAGS="-DANDROID -DNGX_SYS_NERR=1 -DIOV_MAX=16 $EDEFS_123 -I$TOP_DIR/compat -I$TOP_DIR/compat/libcrypt" ./configure --prefix=/sdcard/serv/stow/c-ares-$PKGVER   --target=arm-linux --host=x86_64;
