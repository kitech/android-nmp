...
CC="$ACC" CXX="$ACXX" LD=$ALD LDFLAGS="-lc -L$INS_DIR/ncurses-5.9/lib -lncurses $INS_DIR/ncurses-5.9/lib/libncurses.a -L$INS_DIR/readline-6.2/lib -lreadline $INS_DIR/readline-6.2/lib/libreadline.a" CXXFLAGS="-DANDROID -DNGX_SYS_NERR=1 -DIOV_MAX=16 $EDEFS_123 -I$TOP_DIR/compat -I$TOP_DIR/compat/libcrypt -I$INS_DIR/ncurses-5.9/include/ncurses -I$INS_DIR/readline-6.2/include" cmake ../mysql-5.5.32/ -DCMAKE_VERBOSE_MAKEFILE=on -DWITH_FEDERATED_STORAGE_ENGINE=off -DWITH_UNIT_TESTS=off
