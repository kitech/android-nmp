...
CC="$ACC" BUILD_CC="$ACC" LD=$ALD LDFLAGS_DEP="-lc" CPPFLAGS="-DANDROID -DNGX_SYS_NERR=1 -DIOV_MAX=16 $EDEFS_123 -I$TOP_DIR/compat -I$TOP_DIR/compat/libcrypt -I$INS_DIR/c-ares-1.10.0/include" ./configure --prefix=/sdcard/serv/stow/curl-$PKGVER --enable-ares=$INS_DIR/c-ares-1.10.0  --target=arm-linux --host=x86_64;
